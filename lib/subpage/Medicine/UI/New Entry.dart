  ...
  Future<void> scheduleNotification(Medicine medicine) async {
    ...
    for (int i = 0; i < (24 / medicine.interval).floor(); i++) {
      ...
      await flutterLocalNotificationsPlugin?.zonedSchedule(
          ...
          TimeOfDay(hour: hour, minute: minute) as TZDateTime,
      ...
      child: Container(
        child: Row(
          ...
          children: <Widget>[
            ...
            DropdownButton<int>(
              iconEnabledColor: const Color(0xFF1CC8A5),
              hint: _selected == 0
                  ? const Text(
                      "Select an Interval",
                      style: TextStyle(
        ...
        children: <Widget>[
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: isSelected ? const Color(0xFF1CC8A5) : Colors.white,
            ),
            child: Center(
              child: Padding(
          ...
          Padding(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color:
                    isSelected ? const Color(0xFF1CC8A5) : Colors.transparent,
    ...
    return Padding(
      ...
      child: Text.rich(
        TextSpan(children: <TextSpan>[
          ...
          TextSpan(
            text: isRequired ? " *" : "",
            style: const TextStyle(fontSize: 14, color: Color(0xFF1CC8A5)),
          ),
        ]),
      ),
    );
